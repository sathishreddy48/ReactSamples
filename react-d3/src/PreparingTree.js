    ...
    PrepareTree() {
        var treeData = [{
            ...
            },
            {
                ...
                "children": [{
                    "ScriptFileId": 11,
                    "FilePath": "\\\\servername\\sharedfoldername\\11.sql",
                }]
            },
            {
                "ScriptFileId": 2,
                ...
                "children": [{
                        "ScriptFileId": 4,
                        "FilePath": "\\\\servername\\sharedfoldername\\4.sql"
                    },
                    {
                        "ScriptFileId": 5,
                        "FilePath": "\\\\servername\\sharedfoldername\\5.sql"
                    }
                ]
            },
            {
            ...
            },
            {
                ...
                "children": [{
                    "ScriptFileId": 13,
                    "FilePath": "\\\\servername\\sharedfoldername\\13.sql"
                }]
            },
            {
                "ScriptFileId": 81,
            ...
            },
            {
                ...
                "children": [{
                    ...
                    {
                        "ScriptFileId": 7,
                        "FilePath": "\\\\servername\\sharedfoldername\\7.sql"
                    }
                ]
            },
            {
                ...
                "children": [{
                        "ScriptFileId": 8,
                        "FilePath": "\\\\servername\\sharedfoldername\\8.sql"
                    },
                    {
                        "ScriptFileId": 9,
                        "FilePath": "\\\\servername\\sharedfoldername\\9.sql"
                    }
                ]
            },
        ];
        ...
        function FindIndependentScripts(treeData) {
            ...
            treeData.forEach(e => {
                if (e.children !== undefined && e.children.length !== 0) {
                    e.children.forEach(child =>
                        Parentchilds.push({
                            'Parent': e.ScriptFileId,
                            'Child': child.ScriptFileId
                        })
                    )
                }
            });
            ...
            sortedParentchilds.forEach((Topelem) => {
                ...
                if (!ismultiparent) {
                    ...
                    SingleParentchilds.push({
                        'Parent': Topelem.Parent,
                        'Child': Topelem.Child
                    });
                }
            ...
            SingleParentchilds.forEach((element) => {
                if (Values.indexOf(element.Parent) === -1 && RootElements.indexOf(element.Parent) === -1) {
                     ...
                     RootElementsList.push({'Parent':element.Parent,'Child':element.Child})
                     console.log('Root  Parent '+element.Parent+'Child'+element.Child);
                }
            });
        }
           ...
           function update(source, index) {
               ...
               nodes.forEach(function (d, childIndex) { 
                   //d.y = source. + (childIndex - childNodeCount / 2) *40; 
                    d.y = d.depth * 200; 
               });
               // Declare the nodes
        ...
        function printIndependentFiles()
        {
